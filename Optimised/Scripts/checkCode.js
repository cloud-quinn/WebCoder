...
var missingH1 = "Try dragging the heading icon onto the code area to make a heading.";
var missingA = "Try dragging the link icon onto the code area to make a link.";
var missingIMG = "Try dragging the image icon onto the code area to make an image.";
...
var missingStyle = "Try dragging the icons onto the code area to make styles, just like you did in the HTML.";
                                    ...
                                    $("#dialog-success").dialog({
                                        ...
                                        buttons: {
                                            OK: function () {
                                                ...
                                                window.location.href = "http://www.webcoder.org.uk/Home/TutorialComplete";
                                            }
                                        }
                                    });
                                }
